...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        ...
        var yesorno = readData("yesorno");
        var clear = readData("clear");
        var best = readData("best");
        var highlight = readData("highlight");
        var comment = readData("comment");
        res.render('showResults', {results: [name, yesorno, clear, highlight, best, comment]});
        console.log([name, yesorno, clear, highlight, best, comment]);
    });
    ...
    app.post('/niceSurvey', urlencodedParser, function(req, res){
        ...
        for (var key in json){
            ...
            if ((key === "highlight") && (json[key].length === 2)){
